...
- [frontend API client](../../../packages/frontend/src/lib/api/client.ts)
- [frontend WebSocket client](../../../packages/frontend/src/lib/api/websocket.ts)
...
The backend already contains frozen-runtime handling and frontend build path resolution logic in [backend main](../../../packages/backend/main.py). That support should be treated as a starting point, not final proof that packaging is production-ready.
