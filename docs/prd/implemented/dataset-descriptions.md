...
- [x] Datasource model supports nullable `description`
- [x] Datasource create and update APIs accept `description`
- [x] Datasource list and detail APIs return `description`
- [x] Dataset creation forms include a description field
- [x] Dataset detail/settings surfaces support editing description
