...
- [x] Export modal accessible from analysis editor toolbar
- [x] Polars export produces a runnable Python script for a pipeline with filter, join, group_by, and sort steps
- [x] SQL export produces valid PostgreSQL-compatible SQL for the same pipeline
- [x] Per-tab export works correctly
- [x] Untranslatable steps produce clear comments/warnings
- [x] Copy to clipboard works
- [x] Download produces correctly named files
- [x] Syntax highlighting in the modal
