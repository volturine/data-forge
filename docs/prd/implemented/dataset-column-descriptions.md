...
- [x] Every active dataset column can store a nullable description
- [x] Datasource schema responses include `description` per column
- [x] Users can edit column descriptions from the schema UI
- [x] AI-facing read/write contracts can ingest and update descriptions
- [x] Descriptions persist across schema refresh when column names remain stable
- [x] Removed columns do not appear with stale descriptions in the default schema view
