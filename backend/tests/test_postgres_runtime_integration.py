...
def test_init_db_bootstraps_public_and_tenant_schemas_in_postgres(monkeypatch, tmp_path: Path) -> None:
    ...
    with PostgresContainer() as container:
        ...
        with container.connect() as connection:
            ...
            assert _query_value(connection, 'SELECT version_num FROM "default".alembic_version') == '0003_tenant_ds_desc'
            assert _query_value(connection, 'SELECT version_num FROM alpha.alembic_version') == '0003_tenant_ds_desc'
