...
>
	<select
		...
		{disabled}
		class="cursor-pointer border transition-colors disabled:cursor-not-allowed disabled:opacity-60 hover:not-disabled:border-tertiary hover:not-disabled:bg-primary focus:outline-2 focus:outline-offset-2 focus:outline-info focus:border-info max-[480px]:w-full {size ===
		'sm'
