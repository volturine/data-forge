...
_MODEL_MODULES = (
    'persistence.analysis.models',
    'persistence.analysis_versions.models',
    'persistence.build_jobs.models',
    'persistence.build_runs.models',
    'persistence.compute_requests.models',
    'persistence.datasource.models',
    'persistence.engine_instances.models',
    'persistence.engine_runs.models',
    'persistence.healthchecks.models',
    'persistence.locks.models',
    'persistence.namespaces.models',
    'persistence.runtime_events.models',
    'persistence.runtime_workers.models',
    'persistence.scheduler.models',
    'persistence.settings.models',
    'persistence.telegram.models',
    'persistence.udfs.models',
)
