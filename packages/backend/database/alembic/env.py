...
_MODEL_MODULES = (
    'backend_core.persistence.analysis.models',
    ...
    'backend_core.persistence.scheduler.models',
    'backend_core.persistence.settings.models',
    'backend_core.persistence.telegram.models',
    'backend_core.persistence.udfs.models',
)
