...
from backend_core.exceptions import DataSourceSnapshotError
...
def test_scan_iceberg_snapshot_inserts_missing_columns(monkeypatch):
    ...
    monkeypatch.setattr('backend_core.iceberg_snapshot_reader.StaticTable.from_metadata', MagicMock(return_value=table))
